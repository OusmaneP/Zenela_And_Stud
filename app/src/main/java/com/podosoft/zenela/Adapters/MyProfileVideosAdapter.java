...
public class MyProfileVideosAdapter extends RecyclerView.Adapter<MyProfileVideosViewHolder>{
    Context context;
    List<Post> posts;
    ...
    @NonNull
    @Override
    public MyProfileVideosViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyProfileVideosViewHolder(LayoutInflater.from(context).inflate(R.layout.my_profile_videos_cardview, parent, false));
    }

    @SuppressLint("UseCompatLoadingForDrawables")
    @Override
    public void onBindViewHolder(@NonNull MyProfileVideosViewHolder holder, int position) {
...
class MyProfileVideosViewHolder extends RecyclerView.ViewHolder{
    ...
    public MyProfileVideosViewHolder(@NonNull View itemView) {
        super(itemView);
